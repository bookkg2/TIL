				...
				<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
					...
					<form action="customerregister.mc" method="POST">
						...
						<div class="col-sm-6 p-b-5 m-lr-auto ">
							...
							<input class="size-111 bor8 stext-102 cl2 p-lr-20" id="name" type="text" name="CUSTOMER_NM">
						</div>

						<div class="col-sm-6 p-b-5 m-lr-auto ">
							<label class="stext-102 cl3" for="name">PHONE</label>
							<input class="size-111 bor8 stext-102 cl2 p-lr-20" id="phone" type="text" name="CUSTOMER_PHONE">
						</div>

						<div class="col-sm-6 p-b-5 m-lr-auto ">
							<label class="stext-102 cl3" for="name">ADDRESS</label>
							<input class="size-111 bor8 stext-102 cl2 p-lr-20" id="address" type="text" name="CUSTOMER_ADDR">
						</div>
	
						<div class="col-sm-6 p-b-5 m-lr-auto ">
							<label class="stext-102 cl3" for="email">EMAIL</label>
							<input class="size-111 bor8 stext-102 cl2 p-lr-20" id="email" type="text" name="CUSTOMER_EMAIL">
						</div>
						
						<label class="stext-102 cl3"></label>
						<input type="submit" class="flex-c-m m-lr-auto stext-101 cl0 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer" style="width : 300px; height : 50px" value="REGISTER">
