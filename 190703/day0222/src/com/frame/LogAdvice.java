...
public class LogAdvice {
	...
	@Before("execution(* com.user..*Biz.insert(..))")
	...
	@AfterReturning(pointcut="execution(* com.user..*Biz.select(..))",returning="returnObj")
	public void afterLog(JoinPoint jp,Object returnObj) {
		
		System.out.println("[after] 비즈니스 로직 수행  ....");
		System.out.println("Log Result : " + returnObj);
	}
	@AfterThrowing(pointcut="execution(* com.user..*Biz.select(..))",throwing ="ex")
	...
	@Around("execution(* com.user..*Biz.select(..))")
